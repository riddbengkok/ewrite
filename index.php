...
<body>
	<form action="" method="get">
		<textarea name="article" id="art" cols="200" rows="10"><?php if($article1){
	echo $article1; }?></textarea>
		<button type="submit" id="punch">Punch!</button>
...
// echo $article;
?>
<textarea name="hasil" id="hasil" cols="200" rows="10"><?php echo $article; ?></textarea>
	</form>
</body>
</html>